...
class Space {
  ...
  static EdgeInsets? h;
  static EdgeInsets? v;
  static EdgeInsets? h0;
  static EdgeInsets? v0;
  ...
  static void init() {
    x0 = SizedBox(width: AppDimensions.space(0.3));
    y0 = SizedBox(height: AppDimensions.space(0.3));
    ...
    h0 = EdgeInsets.symmetric(horizontal: AppDimensions.space(0.7));
    v0 = EdgeInsets.symmetric(vertical: AppDimensions.space(0.7));
